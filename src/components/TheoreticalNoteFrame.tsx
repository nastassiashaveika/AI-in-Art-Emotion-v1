            ...
            {showTechnical && (
              <div style={{ padding: '0 1rem 1.25rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1rem' }}>
                  {['Full painting', 'Grid overlay', 'Patches to vectors', 'Language model', 'Output'].map((label, i) => (
                    <button
                      key={label}
                  ...
                  {pipelineStep === 3 && (
                    <div style={{ padding: '1.5rem', textAlign: 'center' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <svg viewBox="0 0 20 10" width="20" height="10" style={{ display: 'inline-block', verticalAlign: 'middle' }} aria-hidden="true"><line x1="0" y1="5" x2="13" y2="5" stroke="#888" strokeWidth="1.5"/><polyline points="9,1 13,5 9,9" stroke="#888" strokeWidth="1.5" fill="none" strokeLinejoin="round"/></svg>
                        <div style={{
                ...
                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
                  <strong>The pipeline has no emotion recognition module.</strong>
                </p>

                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '1rem' }}>
                  Vision-language models, like GPT-4o, predict tokens. 
                </p>
                ...
                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '0.75rem', fontStyle: 'italic', borderLeft: '3px solid var(--subtle-border)', paddingLeft: '0.75rem' }}>
                  GPT-4o's exact vision architecture is not publicly documented. What follows describes a standard Vision Transformer pipeline, which underlies most CLIP-based systems, for illustration.
                </p>
                ...
                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
                  After all layers, the CLS token's final state is a single vector, a compressed summary of the entire image. This is what gets passed forward. At this point the model has a rich representation of visual surface features: texture, color distribution, compositional structure. It lacks the cultural grounding needed to interpret traditions underrepresented in training — the narrative context, iconographic conventions, and historical specificity of a 15th-century Christian martyrdom scene.
                </p>

                {/* ===== CLIP ===== */}
                <div style={{ borderTop: '1px solid var(--subtle-border)', margin: '1.5rem 0' }} />
                <h4 style={{ color: 'var(--accent-color)', fontWeight: 700, marginBottom: '0.75rem' }}>
                  How CLIP connects vision to words
                </h4>

                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
                  On its own, a vision encoder has no connection to language. <strong>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '2rem', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      ...
                      <svg viewBox="0 0 20 10" width="20" height="10" style={{ display: 'inline-block', verticalAlign: 'middle' }} aria-hidden="true"><line x1="20" y1="5" x2="7" y2="5" stroke="#888" strokeWidth="1.5"/><polyline points="11,1 7,5 11,9" stroke="#888" strokeWidth="1.5" fill="none" strokeLinejoin="round"/></svg>
                    </div>
                ...
                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
                  ...
                  , the dataset most commonly used for VLM pre-training, found significant skew toward Western subjects, English-language descriptions, and content from a small number of countries. The dataset was assembled by scraping the publicly indexed web, which inherits the web's own demographic and linguistic imbalances. The representation gap shows in the data: EmoArt's training set is 97.6% Western art — Eastern art is a 2.4% rounding error in the system that labeled it.
                </p>
                ...
                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
                  ...
                  {' '}(Zhai et al., 2023) rather than CLIP. SigLIP looks at an individual pair of image and caption and determines if it is a match; then it classifies each pair independently as a match or not, without comparing across the batch. This makes training more stable and allows more multilingual data to be included.
                </p>
                ...
                <div style={{ borderTop: '1px solid var(--subtle-border)', margin: '1.5rem 0' }} />
                <h4 style={{ color: 'var(--accent-color)', fontWeight: 700, marginBottom: '0.75rem' }}>
                  Token prediction instead of emotion recognition
                </h4>
                ...
                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
                  The model produces a probability distribution over its entire vocabulary, 32,000 or more tokens. The model samples from this distribution — "Calm" is more likely to be drawn when its probability is highest — and appends the result; the process repeats for each subsequent word.
                </p>

                <p style={{ color: 'var(--text-color)', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
                  Calm wins because the visual patterns similar to the painting were mostly followed by the word "calm" in training data. The model has no emotion module, no cultural knowledge lookup, no interpretive framework. It has learned that certain surface features (low contrast, muted palette, sparse composition) statistically co-occur with "calm." When it encounters a Chinese ink painting, those features activate, and the distribution peaks accordingly.
                </p>
                ...
                {/* ===== FIVE ARCHITECTURES, SAME BIAS ===== */}
                <div style={{ borderTop: '1px solid var(--subtle-border)', margin: '1.5rem 0' }} />
                <h4 style={{ color: 'var(--accent-color)', fontWeight: 700, marginBottom: '0.75rem' }}>
                  Five models, same bias
                </h4>

                {/* VISUAL: Five-column results table */}
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.8rem' }}>
                    <thead>
                      <tr style={{ borderBottom: '2px solid var(--text-color)' }}>
                        ...
                        <th style={{ padding: '0.5rem', textAlign: 'center', color: 'var(--text-color)' }}>GPT-5.1</th>
                        <th style={{ padding: '0.5rem', textAlign: 'center', color: 'var(--text-color)' }}>Gemini 2.5</th>
                        <th style={{ padding: '0.5rem', textAlign: 'center', color: 'var(--text-color)' }}>Haiku 4.5</th>
                        <th style={{ padding: '0.5rem', textAlign: 'center', color: 'var(--text-color)' }}>Sonnet 4.5</th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ padding: '0.5rem', textAlign: 'center', color: 'var(--text-color)' }}>6.2%</td>
                        <td style={{ padding: '0.5rem', textAlign: 'center', color: 'var(--text-color)' }}>12.5%</td>
                        <td style={{ padding: '0.5rem', textAlign: 'center', color: 'var(--text-color)' }}>12.5%</td>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--muted-text)', fontSize: '0.7rem', marginTop: '0.25rem', fontStyle: 'italic' }}>
                    Source: Birhane et al. (2021), "Multimodal Datasets: Misogyny, Pornography, and Malignant Stereotypes."
                  </p>
                </div>
