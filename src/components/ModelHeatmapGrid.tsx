...
const artworks: Artwork[] = [
  ...
  { id: 1, artist: 'Wu Guanzhong', title: 'The Hometown of Shakespeare',
    desc: 'Ink and wash. A Tudor street scene — black-and-white half-timbered buildings, colorful crowds, storefront signs. Wu was Chinese, painting England, using both traditions at once.',
  ...
  { id: 2, artist: 'Shotei Takahashi', title: 'Cats with Ball',
    desc: 'Shin-hanga woodblock print. Two kittens — one white, one black — batting at a ball tied with a pink ribbon. Charming and uncomplicated.',
  ...
  { id: 3, artist: 'Attr. Wang Zhenpeng (傳王振鵬)',
    desc: 'Ming dynasty ink and color on silk. Branches twist across a warm, aged ground — spare, deliberate, still.',
  ...
  { id: 4, artist: 'Anonymous Qing court painter', title: 'Western Missionary Portrait',
    desc: 'Qing dynasty oil on Korean paper. A Western missionary in a red cloak and white robes, staff and rosary in hand. A deliberate attempt to blend European portraiture into a Chinese visual language.',
  ...
  { id: 5, artist: 'Zheng Jin (鄭錦)', title: 'Sunset over a Distant Road',
    desc: 'Chinese ink painting. A lone traveler and his donkey at sunset — drooping postures, muted palette, the weight of a long journey.',
  ...
  { id: 6, artist: 'Li Gonglin (李公麟)', title: 'Realm of the Immortals',
    desc: 'Ink on paper scroll. Misty mountains, a waterfall, tiny figures moving through drifting clouds. The kind of painting that\'s supposed to make you feel small.',
  ...
  { id: 7, artist: 'Paul Jacoulet', title: "L'Attente, Celebes, Menado",
    desc: 'Ukiyo-e influenced print. A woman in ornate dress, lounging with a cigarette. The title means "The Wait" — but she looks anything but passive.',
  ...
  { id: 8, artist: 'Schneider', title: 'Opus 110',
    desc: 'Tachisme. Black slashes over green — gestural, forceful, layered. Michel Ragon compared Schneider\'s paintings to "an orchestra." I agree.',
  ...
  { id: 9, artist: 'Prampolini', title: 'Sirene',
    desc: 'Italian Futurism. A fractured portrait — exaggerated, sensual features broken into angular planes. Disorienting by design.',
  ...
  { id: 10, artist: 'Kmetty János', title: 'Self-Portrait',
    desc: 'Cubism. A self-portrait in cool greens and fractured planes. Unflinching — there\'s contained tension in how it\'s built.',
  ...
  { id: 11, artist: 'Sally Gabori', title: 'Dibirdibi Country',
    desc: 'Indigenous Australian abstract painting. Gabori, a Kaiadilt woman, began painting in her 80s — bold, sweeping color mapping ancestral land and sea. EmoArt labeled this "Native Art" and placed it under Western. It isn\'t.',
  ...
  { id: 12, artist: 'Matisse', title: 'View of Collioure',
    desc: 'Fauvism. A Mediterranean village in an explosion of color — pinks, oranges, purples, blues. Not subtle, and not trying to be.',
  ...
  { id: 13, artist: 'Miguel Cabrera', title: 'The Virgin of the Apocalypse',
    desc: 'Mexican Baroque, 1780s. The Virgin ascending among angels, an archangel fighting a multi-headed dragon below. Dramatic by design.',
  ...
  { id: 14, artist: 'Makinti Napanangka', title: 'Travels of the Kungka Kutjarra',
    desc: 'Indigenous Australian dot painting. Intense vertical strokes in yellows, oranges, reds — rhythmic, pulsing, vibrating with heat. EmoArt labeled this "Abstract Expressionism." It\'s a different tradition entirely.',
  ...
  { id: 15, artist: 'Oscar Dominguez', title: 'Los platillos volantes',
    desc: 'Surrealism. Waves spiraling into dark vortexes, a tiny boat caught in the middle. Feels dangerous.',
  ...
  { id: 16, artist: 'Benton', title: 'Midwest',
    desc: '1930s Regionalism. Muscular farmers harvesting wheat — bodies straining, communal, proud. Physical labor as subject matter, not commentary on it.',
  ...
  { id: 17, artist: 'Ramirez Villamizar', title: 'Nido de Serpientes',
    desc: 'Constructivism. Interlocking angular metal forms — cold, geometric, no warmth anywhere. The title is "Nest of Snakes."',
  ...
  { id: 18, artist: 'Solomko — Forever Together',
    desc: 'Art Nouveau. Two figures in classical dress, mid-embrace — warm golden tones, luxurious draped fabric. Tender.',
  ...
  { id: 19, artist: 'Filippino Lippi', title: 'Portrait of an Old Man',
    desc: 'Early Renaissance. An old man in a white cap against a deep blue ground. Lined face, direct gaze — grave, or just tired?',
  ...
  { id: 20, artist: 'Guglielmi', title: 'Things of the Sea',
    desc: 'Surrealism. A beach scene — shells, sand dunes, turquoise water — emptied out, dreamlike. Profoundly still.',
    image: guglelmiImage, region: 'Western', emoart: 'Contentment',
    p1: ['Calm', 'Calm', 'Calm', 'Calm', 'Calm'],
    p2: ['Bored', 'Calm', 'Bored', 'Calm'] },

  { id: 21, artist: 'Vajda Lajos', title: 'Fire-Eye',
    desc: 'Symbolism. A figure with a flame-shaped orange head and wide, staring eyes — body flat and inert. Unsettling.',
  ...
  { id: 22, artist: 'Solomko — Rainbow',
    desc: 'Renaissance fresco style. Figures sheltering under a tree, watching a rainbow appear after a storm. Gentle — hope, or just relief.',
  ...
  { id: 23, artist: 'Filippo Lippi', title: 'The Funeral of St. Stephen',
    desc: 'Early Renaissance fresco. A procession of mourners around the body of St. Stephen — grief, reverence, community. This is the painting from the introduction.',
...
export const ModelHeatmapGrid: React.FC = () => {
  ...
  return (
    <div style={{ marginTop: '1.5rem' }}>
      ...
      <p style={{ color: 'var(--text-color)' }}>
        The pattern is immediate. Toggle to Prompt 2 and see GPT-4o's calm cells disappear. Sonnet's labels don't change at all.
      </p>
    </div>
  );
};