      ...
      <div className="pudding-container">
        ...
        <div className="space-y-4">
          ...
          <p style={{ color: 'var(--text-color)' }}>
            Everything I found so far came from one model. The 132,895 artworks in the EmoArt dataset were all labeled by GPT-4o. Maybe the problems above were GPT-4o problems rather than AI at scale.
          </p>
            ...
            {showMethodology && (
              <div style={{ padding: '0.75rem 1rem 1rem', borderTop: '1px solid var(--subtle-border)' }}>
                ...
                <ul style={{ color: 'var(--text-color)', listStyleType: 'disc', paddingLeft: '1.5rem', marginBottom: '0.75rem', fontSize: '0.95rem' }}>
                  <li style={{ marginBottom: '0.4rem' }}><strong>Regional balance:</strong> 7 Eastern and 16 Western artworks. The EmoArt dataset is 97.6% Western.</li>
                ...
                <p style={{ color: 'var(--text-color)', marginBottom: '0.75rem' }}>
                  I categorized artworks as "Eastern" or "Western" — a binary I'm aware is reductive, but necessary to test whether the cultural patterns from the EmoArt analysis held across models.
                </p>
          ...
          <p style={{ color: 'var(--text-color)' }}>
            Before working with the models, I sat down with each piece myself, trying to figure out what I was seeing. Of course, being AI in this situation was not easy, and the choices were complicated.
          </p>
          ...
          >
            <p style={{ color: 'var(--text-color)' }}>
              The Fauvist painting isn't just "happy." It's joyful in a way that's also energetic, spontaneous, and a bit wild. Is that "Happy" or "Excited" or "Glad"? (I went with "Excited" because the brushwork felt more kinetic than peaceful, but, honestly, could have been any of these.)
            </p>
          </ArtworkCaseStudy>
          ...
          >
            <p style={{ color: 'var(--text-color)' }}>
              The Baroque scene depicts a virgin emerging, but in the Baroque tradition, the face conveys peaceful acceptance. It combines pain with transcendence, fear with faith. The painting attempts to describe both suffering and spiritual triumph. 
            </p>
          ...
          >
            <p style={{ color: 'var(--text-color)' }}>
              Five models, five different answers. Sonnet 4.5 described this as "an Art Deco illustration depicting a figure in luxurious, ornate clothing" — misidentifying Ukiyo-e and still landing on a different emotion.
            </p>
          </ArtworkCaseStudy>
          ...
          >
            <p style={{ color: 'var(--text-color)' }}>
              Five out of five: "calm." Every model, every prompt. And I get it. But that's the problem — when your only available label for an entire aesthetic tradition is "calm," the taxonomy itself is the bias.
            </p>
          </ArtworkCaseStudy>
          ...
          <p style={{ color: 'var(--text-color)' }}>
            <strong>Second, the cultural bias exists across models.</strong> Every model labeled Eastern artworks "calm" at higher rates than Western artworks. 
          </p>
